...
?>
	...
	<footer id="footer" role="contentinfo">
        ...
        <article class="primeira-parte container align">
			...
			<article class="icons">
				<p class="title-siga">Siga-nos nas nossas redes sociais:</p>
				<div class="icones align">
					<a href="<?php echo $instagram ?>" alt="Instagram" title="Instagram" class="instagram" target="_blank">
