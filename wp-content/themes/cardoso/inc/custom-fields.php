...
//Pagina home
  ...
  $post_metabox->set_fields(
    ...
    // Linha do tempo
      array(
        'id'          => 'ano1', // Obrigatório
        'label'       => __( 'Ano 1', 'odin' ), // Obrigatório
        'type'        => 'text', // Obrigatório
        'default'     => '1974', // Opcional
      ),
      array(
        'id'          => 'texto-ano1', // Obrigatório
        'label'       => __( 'Texto ano 1', 'odin' ), // Obrigatório
        'type'        => 'textarea', // Obrigatório
      ),
      array(
        'id'          => 'ano2', // Obrigatório
        'label'       => __( 'Ano 2', 'odin' ), // Obrigatório
        'type'        => 'text', // Obrigatório
        'default'     => '1989', // Opcional
      ),
      array(
        'id'          => 'texto-ano2', // Obrigatório
        'label'       => __( 'Texto ano 2', 'odin' ), // Obrigatório
        'type'        => 'textarea', // Obrigatório
      ),
      array(
        'id'          => 'ano3', // Obrigatório
        'label'       => __( 'Ano 3', 'odin' ), // Obrigatório
        'type'        => 'text', // Obrigatório
        'default'     => '1994', // Opcional
      ),
      array(
        'id'          => 'texto-ano3', // Obrigatório
        'label'       => __( 'Texto ano 3', 'odin' ), // Obrigatório
        'type'        => 'textarea', // Obrigatório
      ),
      array(
        'id'          => 'ano4', // Obrigatório
        'label'       => __( 'Ano 4', 'odin' ), // Obrigatório
        'type'        => 'text', // Obrigatório
        'default'     => '2004', // Opcional
      ),
      array(
        'id'          => 'texto-ano4', // Obrigatório
        'label'       => __( 'Texto ano 4', 'odin' ), // Obrigatório
        'type'        => 'textarea', // Obrigatório
      ),
      array(
        'id'          => 'ano5', // Obrigatório
        'label'       => __( 'Ano 5', 'odin' ), // Obrigatório
        'type'        => 'text', // Obrigatório
        'default'     => '2007', // Opcional
      ),
      array(
        'id'          => 'texto-ano5', // Obrigatório
        'label'       => __( 'Texto ano 5', 'odin' ), // Obrigatório
        'type'        => 'textarea', // Obrigatório
      ),
      array(
        'id'          => 'ano6', // Obrigatório
        'label'       => __( 'Ano 6', 'odin' ), // Obrigatório
        'type'        => 'text', // Obrigatório
        'default'     => '2014', // Opcional
      ),
      array(
        'id'          => 'texto-ano6', // Obrigatório
        'label'       => __( 'Texto ano 6', 'odin' ), // Obrigatório
        'type'        => 'textarea', // Obrigatório
      ),
      array(
        'id'          => 'ano7', // Obrigatório
        'label'       => __( 'Ano 7', 'odin' ), // Obrigatório
        'type'        => 'text', // Obrigatório
        'default'     => 'hoje', // Opcional
      ),
      array(
        'id'          => 'texto-ano7', // Obrigatório
        'label'       => __( 'Texto ano 7', 'odin' ), // Obrigatório
        'type'        => 'textarea', // Obrigatório
      ),
      array(
